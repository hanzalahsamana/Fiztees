...
const PaymentForm = ({ shipping, total, tax, discount, cartItem }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const extractedData = cartItem.map(item => ({
      ...item,
      totalOfProduct: item.discountedPrice * item.quantity,
    }));
    ...
    try {
      ...
      toast.success("Your order has been confirmed and will be delivered in 2 to 3 working days");
      ...
      toast.error("Error in placing order , Please try again: " + err.message);
    }
